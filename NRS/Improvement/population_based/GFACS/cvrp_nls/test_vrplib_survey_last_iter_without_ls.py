...
if __name__ == "__main__":
    ...
    # 固定参数（按需改成你的本地路径/设置）
    ckpt_path = "/public/home/bayp/exp_survey_202509/Improvement/population_based/GFACS/pretrained/cvrp_nls/200/cvrp200_sd0/50.pt"   # 模型文件路径，或 None
    ...
    # ---------- logger ----------
    result_root = '/public/home/bayp/exp_survey_202509/Improvement/population_based/GFACS/cvrp_nls/survey_results_lastgen_no_ls'
    log_path = init_logger(result_root, desc="test_CVRPLIB_Survey")
    logger = logging.getLogger(LOG_NAME)
