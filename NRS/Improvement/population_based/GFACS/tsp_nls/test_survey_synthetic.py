...
def main(ckpt_path, n_nodes, k_sparse, size=None, n_ants=100, n_iter=10, guided_exploration=False, seed=0, test_name=""):
    ...
    data_path = f'/public/home/bayp/exp_survey_202509/0_data_survey/survey_synthetic_tsp/test_tsp{n_nodes}_n128_lkh.txt' 
...
if __name__ == "__main__":
    ...
    args.path = "/public/home/bayp/exp_survey_202509/Improvement/population_based/GFACS/pretrained/tsp_nls/1000/tsp1000_sd0_fromckpt-500_tsp500_sd0_50/20.pt"
