...
def get_options(args=None):
    ...
    parser.add_argument('--val_dataset', type=str, default = '/public/home/bayp/exp_survey_202509/0_data_survey/survey_synthetic_tsp/test_tsp100_n10000_lkh.txt', help='dataset file path')
